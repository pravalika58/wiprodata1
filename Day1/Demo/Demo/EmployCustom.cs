...
namespace Demo
{
    internal class EmployCustom
    {
        static void Main()
        {
            ...
            Console.WriteLine("Enter Employ Number, Name and Basic for First Employ  ");
            ...
            Console.WriteLine("Enter Employ Number, Name and Basic for Second Employ  ");
            ...
            Console.WriteLine("Employ Number  " + employ2.empno);
